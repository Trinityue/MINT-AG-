    ...
    if x not in ["1", "2", "3", "4"]:
        ...
        while True:
            ...
            if player_choice in choices:
                counter += int(player_choice) # player added here
                if counter >= 11:
                    print (f"{counter} > 11")
                    print("You lose")
                    player_point -= 1
                    ...
                    continue 
                print(f"You: {counter}")
                counter += int(computer_choice) # com1 added here
                if counter >= 11:
                    print (f"{counter} > 11")
                ...
                print(f"Score: You - {player_point}  Com1 - {com1_point}")
                exit()
        ...
        while True:
            ...
            if player_choice in choices:
                ...
                if counter >= 11:
                    ...
                    continue
                print(f"Com1: {counter}")
                counter += int(computer_choice2) # com2 added here
                if counter >= 11:
                    print (f"{counter} > 11")
                ...
                print(f"Score: You - {player_point}  Com1 - {com1_point} Com2 - {com2_point}")
                exit()
            elif player_choice == "rules" or player_choice == "r":
                print ("The rules are simple. You and the computer take turns to choose a value between 1 and 3.The value will be added to a counter. The first one who makes the counter above 11 loses. Good luck!")
        ...
        while True:
            ...
            if player_choice in choices:
                ...
                if counter >= 11:
                    ...
                    continue
                print(f"Com2: {counter}")
                counter += int(computer_choice3) # com3 added here
                if counter >= 11:
                    print (f"{counter} > 11")
        ...
        while True:
            ...
            if player_choice in choices:
                ...
                if counter >= 11:
                    ...
                    continue
                print(f"Com3: {counter}")
                counter += int(computer_choice4) # com4 added here
                if counter >= 11:
                    print (f"{counter} > 11")
